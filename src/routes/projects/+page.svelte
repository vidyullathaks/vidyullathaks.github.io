...
<svelte:head>
	<title>Projects | Vidyullatha KS</title>
	<meta name="description" content="Projects and work by Vidyullatha KS - Engineering Management Professional" />
</svelte:head>
